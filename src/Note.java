...
public class Note {
  ...
  /**
   *  0 whole, 1 half, 2 quarter, 3 eighth, 4 triplet, 5 silence, 6 dotted half, 7 dotted quarter
   */
  public int type;
  ...
  /**
   *  alteration to be displayed. Can be: -2 = double flat, -1 = flat, 0 = none, 1 = sharp, 2 = natural
   */
  public int altType;

  /**
   *  indicates whether the note is on the first or second row
   */
  public boolean secondRow;

  /**
   *  note level as handled in the ClefSelector
   */
  public int level;

  /**
   *  number of additional lines (if present)
   */
  public int addLinesNumber;

  /**
   *  Y position of the first additional line (if present)
   */
  public int addLinesYpos;
  ...
  /**
   *  used when playing a rhtyhm or score sequence
   */
