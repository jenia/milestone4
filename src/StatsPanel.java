...
public class StatsPanel extends JPanel {
  ...
  public RoundPanel linePanel;

  public RoundPanel rtmPanel;

  public RoundPanel scrPanel;

  public JCheckBox inlineCheckBox;

  public JCheckBox rhythmCheckBox;

  public JCheckBox scoreCheckBox;

  private JLabel lineAvgScoreLabel;

  private JLabel rtmAvgScoreLabel;

  private JLabel scrAvgScoreLabel;

  private JLabel lineAvgScoreResult;

  private JLabel rtmAvgScoreResult;

  private JLabel scrAvgScoreResult;

  private JLabel lineAvgGamesLabel;

  private JLabel rtmAvgGamesLabel;

  private JLabel scrAvgGamesLabel;

  private JLabel lineAvgGamesResult;

  private JLabel rtmAvgGamesResult;

  private JLabel scrAvgGamesResult;

  private JLabel lineAvgPrecLabel;

  private JLabel rtmAvgPrecLabel;

  private JLabel scrAvgPrecLabel;
  ...
  private StatsPanel.GraphPanel graphPanel;
  ...
  /**
   *  Array of filenames (.sds) of the saved stats
   */
  String[] SDSfiles;
   ...
   */
  Vector<StatsPanel.statRecord> currentStats =  new Vector<statRecord>();

  private boolean[] showGame =  { true, true, true };

  /**
   *  score game: start day, end day, min, max, count
   */
  ...
  /**
   *  global info: start day, end day, min, max, count
   */
  private int[] globalInfo =  {  -1 , -1, -1 , -1, 0 };
