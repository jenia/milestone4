...
public class Fluidsynth {
  ...
  public Fluidsynth(String name, int cores, int channels, int polyphony, float sampleRate, String audioDriver, String audioDevice, int deviceIndex, int buffers, int bufferSize, float overflowAge, float overflowPercussion, float overflowReleased, float overflowSustained, float overflowVolume) throws IOException {
  ...
  public void setChorus(int nr, double level, double speed, double depth_ms, int type) {
		setChorus(context, nr, level, speed, depth_ms, type);
  }

  public void setTuning(int tuningBank, int tuningProgram, String name, double[] derivations) {
  ...
  private static native ByteBuffer init(String name, int cores, int channels, int polyphony, float sampleRate, String audioDriver, String audioDevice, int deviceIndex, int buffers, int bufferSize, float overflowAge, float overflowPercussion, float overflowReleased, float overflowSustained, float overflowVolume) throws IOException;

  private static native void destroy(ByteBuffer context);

  private native void soundFontLoad(ByteBuffer context, String filename) throws IOException;
  ...
  private static native void setReverb(ByteBuffer context, double roomsize, double damping, double width, double level);

  private static native void setChorusOn(ByteBuffer context, boolean b);

  private static native void setChorus(ByteBuffer context, int nr, double level, double speed, double depth_ms, int type);

  private static native void setTuning(ByteBuffer context, int tuningBank, int tuningProgram, String name, double[] derivations);
   ...
   */
  public static native List<String> getAudioDrivers();
   ...
   */
  public static native List<String> getAudioDevices(String audioDriver);
